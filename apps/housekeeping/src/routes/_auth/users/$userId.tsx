...
import { HabboFigureEditor } from "../../../components/habbo-figure-editor";
...
function UserEditPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (form.sex !== undefined) payload.sex = form.sex as string;
              ...
              <div className="grid grid-cols-[auto_1fr] gap-3 items-end">
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      window.HabboRegistration?.setGender?.(e.target.value);
                    }}
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    value={value("figure")}
                    onChange={(e) => {
                      setForm((f) => ({ ...f, figure: e.target.value }));
                      window.HabboRegistration?.setFigure?.(value("sex"), e.target.value);
                    }}
                  />
                </div>
              </div>
        ...
        <Card>
          ...
          <CardContent className="px-6 py-0 overflow-hidden">
            <HabboFigureEditor
              ...
              gender={value("sex")}
              onChange={(g, f) =>
                setForm((prev) => ({ ...prev, sex: g, figure: f }))
              }
            />
          </CardContent>
        </Card>
